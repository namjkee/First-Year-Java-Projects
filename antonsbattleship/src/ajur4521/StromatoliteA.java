...
//TODO: make not pick adjacent to existing ships first

public class StromatoliteA implements Player {
	boolean destroy;
	...
	public void transferShot(Coordinate c, ArrayList<Coordinate> origin, ArrayList<Coordinate> destination) {
